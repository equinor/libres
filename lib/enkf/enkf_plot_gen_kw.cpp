...
enkf_plot_gen_kw_type * enkf_plot_gen_kw_alloc( const enkf_config_node_type * config_node ) {
  if (enkf_config_node_get_impl_type( config_node ) == GEN_KW) {
    enkf_plot_gen_kw_type * plot_gen_kw = (enkf_plot_gen_kw_type *)util_malloc( sizeof * plot_gen_kw );
...
const char * enkf_plot_gen_kw_iget_key( const enkf_plot_gen_kw_type * plot_gen_kw, int index) {
  const gen_kw_config_type * gen_kw_config = (const gen_kw_config_type *)enkf_config_node_get_ref( plot_gen_kw->config_node );
...
int enkf_plot_gen_kw_get_keyword_count( const enkf_plot_gen_kw_type * gen_kw ){
    const gen_kw_config_type * gen_kw_config = (const gen_kw_config_type *)enkf_config_node_get_ref( gen_kw->config_node );
