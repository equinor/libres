...
class ForwardModelFormattedPrintTest(ResTest):
    ...
    def test_status_file(self):
        with TestAreaContext("status_json"):
            ...
            s = '{"start_time": null, "jobs": [{"status": "Success", "start_time": 1519653419.0, "end_time": 1519653419.0, "name": "SQUARE_PARAMS", "error": null, "reported_max_memory_usage": 29319168}], "end_time": null, "run_id": ""}'
